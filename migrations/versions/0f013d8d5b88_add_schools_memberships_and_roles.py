...
down_revision: Union[str, Sequence[str], None] = '7ea781a97a00'
...
def upgrade() -> None:
    ...
    sa.Column('role', sa.Enum('student', 'teacher', 'schedule_manager', 'admin', name='membership_role_type'), nullable=False),
